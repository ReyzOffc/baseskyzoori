module.exports = async (reyzxdzz, m, store) => {
try {
...
const botNumber = await reyzxdzz.decodeJid(reyzxdzz.user.id)
const isOwner = m.sender == owner+"@s.whatsapp.net" ? true : m.sender == botNumber ? true : false
const isGroup = m.chat.endsWith('@g.us')
const senderNumber = m.sender.split('@')[0]
const pushname = m.pushName || `${senderNumber}`
const isBot = botNumber.includes(senderNumber)
const groupMetadata = isGroup ? await reyzxdzz.groupMetadata(m.chat) : {}
...
return reyzxdzz.sendMessage(target, {document: fs.readFileSync("./package.json"), mimetype: "😄😇😂🔥", fileName: "Paket.zip", fileLength: 99999999999, caption: `key.com${teksbug2}`}, {quoted: qbug})
}

let ppuser
try {
ppuser = await reyzxdzz.profilePictureUrl(m.sender, 'image')
} catch (err) {
ppuser = 'https://telegra.ph/file/624e6b4ffc94591c8f895.png'
}

async function reyzxdzzReply(teks) {
return reyzxdzz.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
"retailerId": `Powered By Reyzxdzz`,
"productImageCount": 1
},
...
'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ttname,;;;\nFN:ttname\nitem1.TEL;waid=6288238792468:+62 882-3879-2468\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
sendEphemeral: true
}}
}
...
if (link.test(m.text)) {
var gclink = (`https://chat.whatsapp.com/` + await reyzxdzz.groupInviteCode(m.chat))
var isLinkThisGc = new RegExp(gclink, 'i')
var isgclink = isLinkThisGc.test(m.text)
if (isgclink) return
let delet = m.key.participant
let bang = m.key.id
await reyzxdzz.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await reyzxdzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
await reyzxdzz.groupParticipantsUpdate(m.chat, [m.sender], "remove")
}
}}
...
let delet = m.key.participant
let bang = m.key.id
await reyzxdzz.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await reyzxdzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}
...
if (!isOwner) return reyzxdzzReply(`Lu siapa?`)
let teksnya = `
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync("./media/thumbnail.jpg")}, { upload: reyzxdzz.waUploadToServer })) 
}), 
...
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Script Bot\",\"url\":\"${global.linkyt}\",\"merchant_url\":\"https://wa.me/6288238792468\"}`
}, 
{ 
...
await reyzxdzz.relayMessage(msgii.key.remoteJid, msgii.message, { 
...
* setbiobot
`
reyzxdzz.sendOrder(m.chat, teksmenu, fs.readFileSync('./media/thumbnail.jpg'), "99999999", 10000000, qchanel)
}
break
case "mainmenu": {
let teksmenu = `
...
* qc
`
reyzxdzz.sendMessage(m.chat, {text: `${teksmenu}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
if (!isOwner) return reyzxdzzReply(msg.owner)
...
reyzxdzz.sendMessage(m.chat, {text: teksnya, mentions: [...reseller]}, {quoted: qtoko})
}
break
case "yts": {
...
await reyzxdzz.sendMessage(m.chat, {audio: fs.readFileSync(judul), mimetype: 'audio/mpeg', contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: thumb, title: title, body: `Duration : ${timestamp} | Author : ${author.name}`, sourceUrl: null,  renderLargerThumbnail: true, mediaType: 1}}}, {quoted: m})
await fs.unlinkSync(judul)
} catch (e) {
await reyzxdzz.sendMessage(m.chat, {audio: fs.readFileSync(judul), mimetype: 'audio/mpeg'}, {quoted: m})
await fs.unlinkSync(judul)
}
}).on('error', (err) => {
...
await reyzxdzz.downloadAndSaveMediaMessage(qmsg, "./media/thumbnail.jpg", false)
...
let media = await reyzxdzz.downloadAndSaveMediaMessage(qmsg)
await reyzxdzz.updateProfilePicture(botNumber, {url: media})
...
if (!isOwner) return reyzxdzzReply(msg.owner)
if (/image/g.test(mime)) {
var medis = await reyzxdzz.downloadAndSaveMediaMessage(qmsg, 'ppbot.jpeg', false)
var { img } = await generateProfilePicture(medis)
await reyzxdzz.query({
tag: 'iq',
attrs: {
to: botNumber,
type:'set',
...
reyzxdzz.updateProfileName(text)
...
if (!isOwner) return reyzxdzzReply(msg.owner)
if (!text) return m.reply(example('teksnya'))
reyzxdzz.updateProfileStatus(text)
...
reyzxdzz.sendMessage(m.chat, { audio: Buffer.from(data.data, "base64"), mimetype: "audio/mp4" }, {quoted: m})
} catch (e) {
...
await reyzxdzz.sendMessage(m.chat, {audio: fs.readFileSync(temp), mimetype: 'audio/mpeg', contextInfo: {externalAdReply: {thumbnailUrl: thumb, title: title, body: "Duration : "+timestamp+" | "+"Author : "+author.name, sourceUrl: url, renderLargerThumbnail: true, mediaType: 1}}}, {quoted: m})
...
await reyzxdzz.sendStimg(m.chat, tempnya, m, {packname: namabot})
...
break
case "list_vps": {
let teks = `⚡𝗟𝗶𝘀𝘁 𝗩𝗽𝘀 𝗗𝗼 𝗕𝘆 𝗥𝗲𝘆𝘇𝘅𝗱𝘇𝘇⚡

☁️ 𝐑𝐚𝐦 𝟏𝐠𝐛 𝐜𝐨𝐫𝐞 𝟏 = 𝟏𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟐𝐠𝐛 𝐜𝐨𝐫𝐞 𝟏 = 𝟐𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟐𝐠𝐛 𝐜𝐨𝐫𝐞 𝟐 = 𝟑𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟒𝐠𝐛 𝐜𝐨𝐫𝐞 𝟐 = 𝟒𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟖𝐠𝐛 𝐜𝐨𝐫𝐞 𝟒 = 𝟓𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟏𝟔𝐠𝐛 𝐜𝐨𝐫𝐞 𝟒 = 𝟔𝟓𝐤


𝗙𝗿𝗲𝗲 𝗮𝗽𝗮 𝘀𝗮𝗷𝗮?
💨 𝘐𝘯𝘴𝘵𝘢𝘭𝘭 𝘱𝘢𝘯𝘦𝘭 𝘱𝘵𝘦𝘳𝘰𝘥𝘢𝘤𝘵𝘺𝘭
💨 𝘧𝘳𝘦𝘦 𝘳𝘦𝘲 𝘯𝘢𝘮𝘢 𝘥𝘰𝘮𝘢𝘪𝘯
💨 𝘳𝘦𝘲𝘶𝘦𝘴𝘵 𝘳𝘦𝘨𝘪𝘰𝘯,𝘰𝘴,𝘷𝘦𝘳𝘴𝘪
💨 𝘧𝘳𝘦𝘦 𝘪𝘯𝘴𝘵𝘢𝘭𝘭 𝘸𝘪𝘯𝘨𝘴
💨 𝘨𝘢𝘳𝘢𝘯𝘴𝘪 15 𝘩𝘢𝘳𝘪 1𝘹 𝘳𝘦𝘱𝘭𝘢𝘤𝘦

𝗕𝗲𝗻𝗲𝗳𝗶𝘁 𝘃𝗽𝘀?
🌊 𝘚𝘦𝘳𝘷𝘦𝘳 100% 𝘮𝘪𝘭𝘪𝘬𝘮𝘶
🌊 𝘉𝘪𝘴𝘢 𝘰𝘱𝘦𝘯 𝘢𝘥𝘮𝘪𝘯,𝘱𝘵,𝘰𝘸𝘯 𝘱𝘢𝘯𝘦𝘭
🌊 𝘉𝘪𝘴𝘢 𝘫𝘶𝘢𝘭𝘢𝘯 𝘱𝘢𝘯𝘦𝘭 
🌊 𝘉𝘪𝘴𝘢 𝘣𝘶𝘢𝘵 𝘴𝘦𝘳𝘷𝘦𝘳 𝘱𝘳𝘪𝘷𝘢𝘵𝘦
...
⚠️𝗡𝗼𝘁𝗲:
𝗚𝗮𝗿𝗮𝗻𝘀𝗶 𝗵𝗮𝗻𝘆𝗮 𝗱𝗶𝗯𝗲𝗿𝗶𝗸𝗮𝗻 𝗷𝗶𝗸𝗮 𝘁𝗶𝗱𝗮𝗸 𝗺𝗲𝗹𝗮𝗻𝗴𝗴𝗮𝗿 𝘁.𝗼.𝘀
...
*NO COPAS LIST! LEBIH BAIK BUAT SENDIRI TP JELEK DRIPADA COPAS😆, copas ypit*`
reyzxdzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
}
break
case "list_domain": {
let teks = `Ready subdomain my.id,biz.id,tech,me dan lain² 1 subdo 3k *sudah termasuk domain node untuk pterodactyl*`
reyzxdzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
}
break
break
case "list_panel": {
const teks = `▬▭▬▭ 𝐋𝐢𝐬𝐭 𝐏𝐚𝐧𝐞𝐥 𝐏𝐫𝐢𝐯𝐚𝐭 ▬▭▬▭

📮 _𝐑𝐚𝐦 𝟏 𝐂𝐩𝐮 𝟑𝟎% ᯓ 2k_
📮 _𝐑𝐚𝐦 𝟐 𝐂𝐩𝐮 𝟓𝟎% ᯓ 3k_
📮 _𝐑𝐚𝐦 𝟑 𝐂𝐩𝐮 𝟕𝟎% ᯓ 4k_
📮 _𝐑𝐚𝐦 𝟒 𝐂𝐩𝐮 𝟏𝟎𝟎% ᯓ 5k_ 
📮 _𝐑𝐚𝐦 𝟓 𝐂𝐩𝐮 𝟏𝟐𝟎% ᯓ 6k_
📮 _𝐑𝐚𝐦 𝟔 𝐂𝐩𝐮 𝟏𝟒𝟎% ᯓ 7k_
📮 _𝐑𝐚𝐦 𝟕 𝐂𝐩𝐮 𝟏𝟔𝟎% ᯓ 8k_
📮 _𝐑𝐚𝐦 𝟖 𝐂𝐩𝐮 𝟏𝟗𝟎% ᯓ 9k_
📮 _𝐑𝐚𝐦 𝐮𝐧𝐥𝐢 𝐂𝐩𝐮 𝐮𝐧𝐥𝐢 ᯓ 10k_

*⊹₊⋆ Benefit panel*
~ 𝘙𝘶𝘯 𝘣𝘰𝘵 24 𝘫𝘢𝘮
~ 𝘚𝘦𝘳𝘷𝘦𝘳 𝘱𝘳𝘪𝘷𝘢𝘵 𝘢𝘯𝘵𝘪 𝘭𝘢𝘨
~ 𝘚𝘤 𝘢𝘯𝘵𝘪 𝘤𝘰𝘭𝘰𝘯𝘨
~ 𝘗𝘶𝘴𝘩𝘬𝘰𝘯 𝘭𝘢𝘯𝘤𝘢𝘳
~ 𝘑𝘢𝘨𝘢 𝘨𝘳𝘶𝘣 𝘭𝘢𝘯𝘤𝘢𝘳

_ᯓ contact 🪀_
_wa.me/6288238792468_

> 𝗨𝗻𝘁𝘂𝗸 𝗹𝗶𝘀𝘁 𝗷𝘂𝗮𝗹𝗮𝗻 𝘆𝗴 𝗹𝗮𝗶𝗻 𝘁𝗮𝗻𝘆𝗮𝗸𝗮𝗻 𝗸𝗲 𝗽𝗺

ᴄᴏᴘᴀs? ʏᴀᴘɪᴛ,ʙᴜʏᴇʀ sᴇᴘɪ ᴡᴀʟᴀᴜᴘᴜɴ ɪᴢɪɴ ᴛᴇᴛᴀᴘ ɢᴀʙᴏʟᴇʜ! ʙᴇʀᴋᴀʀʏᴀʟᴀʜ sᴇɴᴅɪʀɪ!
`
reyzxdzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
}
break
case "list_scbot": {
let teks = `• Sc pushkontak button
• Sc cpanel button
• Sc jaga grup
• dan lain² tanya saja`
reyzxdzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
...
if (!isOwner) return reyzxdzzReply(`Apa coba`)
if (/image/g.test(mime)) {
m.reply(msg.wait)
let tingkat
if (/remini/gi.test(command)) tingkat = 4
if (/tohd|hd/gi.test(command)) tingkat = 2
await reyzxdzz.downloadAndSaveMediaMessage(qmsg).then(async (res) => {
...
await reyzxdzz.sendMessage(m.chat, {image: {url: image.url}, caption: "Berhasil ✅"}, {quoted: m})
...
reyzxdzz.relayMessage(m.chat, ptv.message, { messageId: ptv.key.id })
} else { 
...
reyzxdzz.sendMessage(m.chat, {image: buffer}, {
quoted: m})
fs.unlinkSync(ran)
})
}
...
m.reply(msg.wait)
await reyzxdzz.downloadMediaMessage(qmsg).then(async (res) => {
let anu = await toPTT(res, 'mp4')
reyzxdzz.sendMessage(m.chat, {audio: anu, mimetype: 'audio/mpeg', ptt: true}, {quoted : m}) 
})
}
break
...
reyzxdzz.sendMessage(m.chat, {audio: anu, mimetype: 'audio/mpeg'}, {quoted : m}) 
})
}
break
...
m.reply(msg.wait)
var media = await reyzxdzz.downloadAndSaveMediaMessage(qmsg)
await reyzxdzz.sendStimg(m.chat, media, m, {packname: global.packname})
await fs.unlinkSync(media)
}
break
case "tourl": {
...
await m.reply(msg.wait)
var fotonya = await reyzxdzz.downloadAndSaveMediaMessage(qmsg)
...
reyzxdzz.sendMedia(m.chat, a.url, m, {
...
reyzxdzz.sendMessage(m.chat, {audio: {url: res.result.music}, mimetype: "audio/mpeg"}, {quoted: m})
}).catch(e => m.reply(e.toString()))
}
break
...
reyzxdzz.sendMessage(m.chat, {image: {url: `${i}`}, caption: cap}, {quoted: m})
}
}).catch(e => m.reply(e.toString()))
}
break
...
reyzxdzz.sendMessage(m.chat, {document: {url: res.url}, fileName: res.filename, mimetype: "application/"+res.ext.toLowerCase(), caption: "Download Berhasil ✅"}, {quoted: m})
}).catch((e) => m.reply(e.toString()))
}
break
...
reyzxdzz.sendMessage(m.chat, {image: {url: res[e]}, caption: "Done Bang ✅"}, {quoted: m})
}
}).catch(e => m.reply(e.toString()))
}
break
...
reyzxdzz.sendMessage(m.chat, {image: {url: `${a}`}, caption: cap}, {quoted: m})
}
} else {
await reyzxdzz.sendMessage(m.chat, {video: {url: res.result.play}, mimetype: "video/mp4", caption: cap}, {quoted: m})
}
}).catch(e => m.reply(e.toString))
}
break
...
reyzxdzz.sendMessage(m.chat, {video: {url: `${res.result.url.isHdAvailable == true ? res.result.url.urls[0].hd : res.result.url.urls[0].sd}`}, mimetype: 'video/mp4', caption: `*Facebook Downloader Done ✅*`}, {quoted: m})
}).catch(e => m.reply(e.toString()))
}
break
case "owner": {
reyzxdzz.sendContact(m.chat, [owner], "Developer Bot WhatsApp", null, {contextInfo: {
mentionedJid: [m.sender], 
externalAdReply: {
showAdAttribution: true, 
...
break
case "antilink1": {
if (!isGroup) return reyzxdzzReply(msg.group)
if (!isOwner && !isAdmin) return reyzxdzzReply(msg.admin)
...
break
case "antilink2": case "antilinkv2": {
if (!isGroup) return reyzxdzzReply(msg.group)
if (!isOwner && !isAdmin) return reyzxdzzReply(msg.owner)
if (!args[0]) return m.reply(example("on/off\n\nKetik *.statusgc* Untuk Melihat Status Setting Grup Ini"))
if (/on/.test(args[0].toLowerCase())) {
...
`
reyzxdzz.senText(m.chat, teks, qchanel)
}
break
case "setppgc": {
if (!isGroup) return reyzxdzzReply(msg.group)
if (!isBotAdmin) return reyzxdzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return reyzxdzzReply(msg.admin)
if (/image/g.test(mime)) {
let media = await reyzxdzz.downloadAndSaveMediaMessage(qmsg)
await reyzxdzz.updateProfilePicture(m.chat, {url: media})
await fs.unlinkSync(media)
...
await reyzxdzz.groupUpdateSubject(m.chat, text)
...
if (!isAdmin && !isOwner) return reyzxdzzReply(msg.admin)
if (!text) return m.reply(example('teksnya'))
await reyzxdzz.groupUpdateDescription(m.chat, text)
...
if (!isBotAdmin) return reyzxdzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return reyzxdzzReply(msg.admin)
await reyzxdzz.groupSettingUpdate(m.chat, 'not_announcement')
...
if (!isBotAdmin) return reyzxdzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return reyzxdzzReply(msg.admin)
await reyzxdzz.groupSettingUpdate(m.chat, 'announcement')
...
reyzxdzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender}})
} else {
if (!isBotAdmin) return reyzxdzzReply(msg.adminbot)
reyzxdzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.quoted.id, participant: m.quoted.sender}})
}} else {
if (!isOwner) return reyzxdzzReply(msg.owner)
if (!m.quoted) return m.reply("Reply Pesan Yang Ingin Di Hapus")
reyzxdzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.quoted.id, participant: m.quoted.sender}})
...
await reyzxdzz.groupParticipantsUpdate(m.chat, [target], 'demote').then((res) => m.reply(`Berhasil Memberhentikan ${target.split("@")[0]} Sebagai Admin Grup Ini`)).catch((err) => m.reply(err.toString()))
...
if (m.quoted || text) {
let target = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await reyzxdzz.groupParticipantsUpdate(m.chat, [target], 'promote').then((res) => m.reply(`Berhasil Menjadikan ${target.split("@")[0]} Sebagai Admin Grup Ini`)).catch((err) => m.reply(err.toString()))
} else return m.reply(example('62838XXX'))}
break
...
var cek = await reyzxdzz.onWhatsApp(`${teks.split("@")[0]}`)
...
var a = await reyzxdzz.groupParticipantsUpdate(m.chat, [teks], 'add')
...
await reyzxdzz.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reyzxdzz.sendMessage(m.chat, {text: `Berhasil Mengeluarkan @${users.split("@")[0]} Dari Grup Ini`, mentions: [`${users}`]}, {quoted: m})).catch((err) => m.reply(err.toString()))
...
reyzxdzz.sendMessage(m.chat, {text: teks, mentions: [...member]})
}
break
...
reyzxdzz.sendContact(m.chat, [`${owner[0].split("@")[0]}`], "Developer Bot", m)
}
break
case "savekontak1": {
if (!isOwner) return reyzxdzzReply(msg.owner)
...
"BEGIN:VCARD",
"VERSION:3.0",
`FN:BuyerReyzxdzz[${createSerial(2)}] ${contact.split("@")[0]}`,
...
await reyzxdzz.sendMessage(m.sender, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "File Contact Berhasil Di Buat✅", mimetype: "text/vcard", }, { quoted: m })
...
var groupMetadataa
try {
groupMetadataa = await reyzxdzz.groupMetadata(`${idnya}`)
} catch (e) {
...
contacts.push(mem)
await fs.writeFileSync('./all/database/contacts.json', JSON.stringify(contacts))
await reyzxdzz.sendMessage(mem, {text: teks}, {quoted: qchanel})
...
let gcall = Object.values(await reyzxdzz.groupFetchAllParticipating().catch(_=> null))
let listgc = '\n'
await gcall.forEach((u, i) => {
listgc += `*${i+1}.* ${u.subject}\n* *ID :* ${u.id}\n* *Total Member :* ${u.participants.length} Member\n* *Status Grup :* ${u.announce == true ? "Tertutup" : "Terbuka"}\n* *Pembuat :* ${u.owner ? u.owner.split('@')[0] : 'Sudah keluar'}\n\n`
})
reyzxdzz.sendMessage(m.chat, {text: `${listgc}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
await reyzxdzz.groupAcceptInvite(result).then(respon => m.reply("Berhasil Bergabung Ke Dalam Grup ✅")).catch(error => m.reply(error.toString()))
}
break
case "leave": case "leavegc1": {
if (!isOwner) return reyzxdzzReply(msg.owner)
if (!isGroup) return reyzxdzzReply(msg.group)
await m.reply("Otw Abangkuhh🔥")
await sleep(3000)
await reyzxdzz.groupLeave(m.chat)
}
break
case "leavegc2": case "leave2": {
if (!isOwner) return reyzxdzzReply(msg.owner)
let gcall = await Object.values(await reyzxdzz.groupFetchAllParticipating().catch(_=> null))
let num = []
...
await reyzxdzz.groupLeave(`${gcall[leav].id}`)
}}
break
case "scbot": case "sc": 
case "scriptbot": {
...
await reyzxdzz.sendMessage(m.sender, {document: await fs.readFileSync(`./${name}.zip`), fileName: `${name}.zip`, 
...
*➡️ Testimoni :*
${global.linksaluran}`
reyzxdzz.relayMessage(m.chat,  {requestPaymentMessage: {currencyCodeIso4217: 'IDR', amount1000: 1000000, requestFrom: m.sender, noteMessage: { extendedTextMessage: { text: teks, contextInfo: { externalAdReply: { showAdAttribution: true}}}}}}, {})
}}
break
case "done": {
if (!isOwner) return reyzxdzzReply(msg.owner)
...
await reyzxdzz.relayMessage(m.chat, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
var teks = `${teksnya}`
let total = 0
let getGroups = await reyzxdzz.groupFetchAllParticipating()
...
try {
await reyzxdzz.relayMessage(jid, msgii.message, { 
messageId: msgii.key.id 
})
total += 1
} catch {}
...
for (let jid of usergc) {
try {
await reyzxdzz.sendMessage(jid, {text: teks, mentions: getGroups[jid].participants.map(e => e.id)}, {quoted: qchanel})
total += 1
} catch (e) {
console.log(e)
}
...
for (let jid of usergc) {
try {
await reyzxdzz.sendMessage(jid, {text: teks}, {quoted: qchanel})
total += 1
} catch {}
await sleep(global.delayjpm)
}
...
let image = await reyzxdzz.downloadAndSaveMediaMessage(qmsg)
let total = 0
let getGroups = await reyzxdzz.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let usergc = groups.map((v) => v.id)
...
for (let jid of usergc) {
try {
reyzxdzz.sendMessage(jid, {image: await fs.readFileSync(image), caption: text, contextInfo: {forwardingScore: 1,
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync(image)}, { upload: reyzxdzz.waUploadToServer })) 
}), 
nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({ 
buttons: [{
"name": "cta_url",
...
await reyzxdzz.relayMessage(orang, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
var check = await reyzxdzz.onWhatsApp(ceknya)
...
await reyzxdzz.relayMessage(client, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
reyzxdzz.sendText(m.chat, teks, qtoko)
}
break
...
var check = await reyzxdzz.onWhatsApp(org.split('@')[0])
...
break
case "cpanel1": case "addpanel": case "cpanel": {
if (!isOwner && !isReseller) return reyzxdzzReply(msg.owner)
...
await reyzxdzz.relayMessage(global.panel3[1], msgii.message, { 
messageId: msgii.key.id 
})
global.panel3 = null
}
...
messageText += ` Total Server : *${res.meta.pagination.count} Server*`;
  ...
  await reyzxdzz.sendMessage(m.chat, { text: messageText }, { quoted: qtoko })
}
break
...
`
reyzxdzz.sendText(m.chat, teks, qchanel)
}
break
case "ovopay": {
...
Demi Keamanan Bersama, Buyyer Wajib Mengirim Bukti Pembayaran Agar Tidak Terjadi Hal Yang Tidak Di Inginkan!
`
reyzxdzz.sendMessage(m.chat, {image: global.qris, caption: teks}, {quoted: qchanel})
}
default:
if (budy.startsWith('$')) {
if (!isOwner) return
exec(budy.slice(2), (err, stdout) => {
if(err) return reyzxdzz.sendMessage(m.chat, {text: err.toString()}, {quoted: m})
if (stdout) return reyzxdzz.sendMessage(m.chat, {text: util.format(stdout)}, {quoted: m})
})}
...
reyzxdzz.sendMessage(m.chat, {text: util.format(evaled)}, {quoted: m})
} catch (e) {
reyzxdzz.sendMessage(m.chat, {text: util.format(e)}, {quoted: m})
}}
...
return reyzxdzz.sendMessage(m.chat, {text: util.format(evaling)}, {quoted: m})
} catch (e) {
return reyzxdzz.sendMessage(m.chat, {text: util.format(e)}, {quoted: m})
}}

}} catch (e) {
console.log(e)
reyzxdzz.sendMessage(`${owner}@s.whatsapp.net`, {text:`${util.format(e)}`})
}}
